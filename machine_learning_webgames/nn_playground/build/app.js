...
/* pica 2.0.3 nodeca/pica */(function (f) {
  ...
  var define, module, exports;return function e(t, n, r) {
    function s(o, u) {
      ...
      //
      var FILTER_INFO = [{ // Nearest neibor (Box)
        win: 0.5,
      ...
      function webglProcessResize(from, gl, options) {
        ...
        convolve(gl, texUnit0, srcW, srcH, texUnit2, '#fsh-lanczos-1d-covolve-horizontal', dstW, srcH, false);

        var finalFboObject = convolve(gl, texUnit2, dstW, srcH, texUnit3, '#fsh-lanczos-1d-covolve-vertical', dstW, dstH, true);
...
var Painter = function () {
  ...
  function Painter(canvasElemId, downSampledSize) {
  ...
  _createClass(Painter, [{
    key: "buildResizeCanvas",
    value: function buildResizeCanvas() {
    ...
    key: "copyOutputCanvas",
    value: function copyOutputCanvas() {
    ...
    key: "getDownSampledAndNormalizedPixels",
    value: function getDownSampledAndNormalizedPixels() {
...
var DataSet = function () {
  ...
  _createClass(DataSet, [{
    key: "add",
    value: function add(pixels, label) {
      // add to datasets
      this.dataSet.push({
        input: pixels,
        output: label
    ...
    key: "import",
    value: function _import(JSONStr) {
...
var NN = function () {
  ...
  function NN(downSampledSize) {
    var hiddenLayer = arguments.length <= 1 || arguments[1] === undefined ? 100 : arguments[1];
    var outputLayer = arguments.length <= 2 || arguments[2] === undefined ? 2 : arguments[2];
  ...
  _createClass(NN, [{
    key: "train",
    value: function train(dataSet, callback) {
      var rate = arguments.length <= 2 || arguments[2] === undefined ? .01 : arguments[2];
      var iterations = arguments.length <= 3 || arguments[3] === undefined ? 50 : arguments[3];
      var error = arguments.length <= 4 || arguments[4] === undefined ? .01 : arguments[4];
      var log = arguments.length <= 5 || arguments[5] === undefined ? 1 : arguments[5];


      // train
      this.trainer.workerTrain(dataSet, callback, {
        rate: rate,
    ...
    key: "trainWithCrossValidation",
    value: function trainWithCrossValidation(dataSet, callback) {
      var rate = arguments.length <= 2 || arguments[2] === undefined ? .01 : arguments[2];
      var iterations = arguments.length <= 3 || arguments[3] === undefined ? 50 : arguments[3];
      var error = arguments.length <= 4 || arguments[4] === undefined ? .01 : arguments[4];
      var log = arguments.length <= 5 || arguments[5] === undefined ? 1 : arguments[5];
    ...
    key: "importNetwork",
    value: function importNetwork(jsonNetwork) {
...
$(document).ready(function () {
  ...
  loadSettings().then(function () {
    ...
    // init neural network
    app.neuralNetwork = new NN(app.settings.neuralnetwork.input, app.settings.neuralnetwork.hidden, app.settings.labels.length);
  });
});
...
function setupCharts() {
  ...
  var labels = app.settings.labels.map(function (label) {
    return label.label;
  });
...
$(document).on('click', '.btn-add', function (event) {
  ...
  // construct label
  for (var i = 0, l = app.settings.labels.length; i < l; i++) {
...
$(document).on('click', '.btn-training-start', function () {
  ...
  }, app.trainingValues.learningRate, app.trainingValues.iterations, app.trainingValues.error, app.trainingValues.log);
});
...
$(document).on('click', '.btn-predict', function () {
  ...
  app.painterCtrl.getDownSampledAndNormalizedPixels().then(function (pixels) {
    ...
    // get results
    var results = app.neuralNetwork.classify(pixels);
